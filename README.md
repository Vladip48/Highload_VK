...
| **Средний размер профиля водителя** | 25 КБ на запись | Структура хранения на одного пользователя: <br>• Личные данные (телефон, имя, email) — 1 КБ <br>• Фото профиля — 0,5 КБ <br>• Платежные токены и избранные адреса — 3 КБ <br>• Накладные расходы СУБД — 10,5 КБ <br> Документы, лицензия, фото авто - 10 КБ|
